...
{
  BuildShader(SHADERPATH"BasicShader.vs", SHADERPATH"BasicShader.fs");
}

/*****************************| PRIVATE MEMBERS |*****************************/

void ShaderManager::BuildShader(std::string vertexShader, std::string fragmentShader)
{
  // Create the shaders
  ...
  //return ProgramID;
  ShaderArray.emplace_back(Shader(ProgramID));
}
